...
> 🔀 This is a personal fork of [hakimi's agent-watch-approve](https://github.com/ghy196830-del/agent-watch-approve) (MIT licensed): adds Antigravity done-notifications, macOS Focus-based autopilot wiring, extended terminal-forced paths, and more. Credit to the original author — the original LICENSE is preserved in this repo.
